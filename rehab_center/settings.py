...
ALLOWED_HOSTS = ['54.82.115.158', 'localhost', '127.0.0.1']  # Replace '*' with specific hosts for security
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'rehab'  # Your Gmail username
EMAIL_HOST_PASSWORD = 'batq vxgt vjlo droj'  # Your app password
DEFAULT_FROM_EMAIL = 'rehab@gmail.com'